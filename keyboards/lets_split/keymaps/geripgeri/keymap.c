...
enum layer_names { _QWERTY, _LOWER, _RAISE, _NUMPAD, _ADJUST };

enum custom_keycodes { NUMPAD = SAFE_RANGE, SLIGHTLY, SMILE, JOY, RELAXED, HEART, SAD, CRY, NETRURAL, SCREAM, THUMBSUP, THINKING, TADA };

enum td_extra_keys { U, O, NEXTPREV, SLASH };
...
[_LOWER] = LAYOUT_ortho_4x12(
  ...
  SLIGHTLY, SMILE, JOY, RELAXED, HEART, TADA,                 KC_HOME, KC_PGUP, KC_WBAK, KC_LCBR, KC_RCBR, KC_PIPE,
  SAD, CRY, NETRURAL, SCREAM, THUMBSUP, THINKING,             KC_END,  KC_PGDOWN, KC_WFWD, KC_LBRC, KC_RBRC, KC_PSCREEN,
...
[_RAISE] = LAYOUT_ortho_4x12(
  ...
  _______, _______, _______, _______, _______, _______,       _______, _______, _______, KC_LABK, KC_RABK, KC_PPLS,
...
static tap utap_state = {.is_press_action = true, .state = 0};

static tap otap_state = {.is_press_action = true, .state = 0};
...
qk_tap_dance_action_t tap_dance_actions[] = {[U] = ACTION_TAP_DANCE_FN(u_finished), [O] = ACTION_TAP_DANCE_FN(o_finished), [NEXTPREV] = ACTION_TAP_DANCE_DOUBLE(KC_MNXT, KC_MPRV), [SLASH] = ACTION_TAP_DANCE_DOUBLE(KC_SLASH, KC_BSLS)};
